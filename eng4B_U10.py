...
Test_title=" Unit 10 Quiz "
Title_per_unit="**** Unit 10-{0} Quiz ****"

TOTAL_UNIT=6 #総合問題も含めたユニット数

ques_template="eng4B_words_U10-{0}_question.txt"                  #問題文を保存するファイル
ans_template="eng4B_words_U10-{0}_answer.txt"                     #問題の解答を保存するファイル
wrong_template="eng4B_words_U10-{0}_wrong_total.txt"              #間違えた問題数の累積を記録するファイル

result_file_name="eng4B_words_U10_result.txt"                     #全てのテスト結果が保存されるファイル
current_result_file_name="eng4B_words_U10_current_result.txt"     #問題を解いたそのときの結果
weak_file_name="eng4B_words_U10_weak_point.txt"                   #☆の入ったテキストファイル
...
def compile_wrong_data():
    ...
    #wrong_template="eng4B_words_U10-{0}_wrong_total.txt"
    #template="eng4B_words_U10-{0}_wrong_total.txt"
...
#テスト結果保存用のファイルを開く
# fileobj_show = open('eng4B_words_U10-5_wrong_total.txt', "r", encoding = "utf_8")
